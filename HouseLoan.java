...
public class HouseLoan extends Loan {
    ...
    public HouseLoan(String Address, String borrowedID, double loanAmount, double interestRate, int months, int creditScore, int monthlyIncome, double amountPerMonth, String dueDate) {
